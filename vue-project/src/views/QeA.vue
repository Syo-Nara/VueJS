...
<template>
  ...
  <body>
    <section>
      <div class="container">
        <h2 class="title has-text-centered">Your Questions, My Answers</h2>
        <div class="block">
          ...
          <div class="card block">
            <div class="card-content">
              <div class="media">
                ...
                <div class="media-content">
                  <h3 class="title is-4">What makes PiperNet so safe?</h3>
                  <p>
        ...
        <div class="buttons is-centered">
          <a class="button is-primary" href="#">See all</a>
        </div>
      </div>
    </section>
  </body>
